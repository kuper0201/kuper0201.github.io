...
thumbnail: cover.jpg
excerpt: "학습된 모델을 통해 피아노 음을 예측하고 MIDI 파일로 변환하는 방법에 대해 설명합니다."
draft: false
---
...
### &nbsp; &nbsp; &nbsp;<a href="https://github.com/kuper0201/Piano_Transcription" target="_blank">Piano_Transcription Github</a>
...
마지막으로, 전체 프로젝트에 대한 코드는 <a href="https://github.com/kuper0201/Piano_Transcription" target="_blank">Piano_Transcription</a>에서 확인하실 수 있습니다.
