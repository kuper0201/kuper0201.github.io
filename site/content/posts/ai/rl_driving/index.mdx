---
title: "강화학습으로 자율주행 모델 학습하기 - 1.전처리"
category: "인공 지능"
author: kuper0201
tags: ['#AI', '#reinforcement-learning', '#projects']
date: 2022-03-02
slug: ai-self-driving-preprocess
thumbnail: cover.jpg
draft: false
---
...
### &nbsp; &nbsp; &nbsp;[자율주행 모델 강화 학습하기 - 1.환경 구축(현재 글)](#서론)
### &nbsp; &nbsp; &nbsp;[자율주행 모델 강화 학습하기 - 2.모델 구현]()
### &nbsp; &nbsp; &nbsp;[자율주행 모델 강화 학습하기 - 3.결과 확인]()
...
1. <a href="https://carla.org/" target="_blank">Carla</a> - 자율 주행 차량 개발에 특화된 오픈 소스 시뮬레이터, 다양한 센서 제공
2. <a href="https://github.com/microsoft/AirSim" target="_blank">AirSim</a> - 정밀한 물리 학습에 특화된 오픈 소스 시뮬레이터, 차량 드론 등의 플랫폼 지원
3. <a href="https://eclipse.dev/sumo/" target="_blank">SUMO</a> - 교통 시뮬레이션에 특화된 오픈 소스 시뮬레이터, GPU가 필요 없는 경량 시뮬레이터
