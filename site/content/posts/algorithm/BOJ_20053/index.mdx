...
빠른 입력을 구현한 클래스인 FileIO 클래스는 rarebook92님의 블로그 중 <a href="https://velog.io/@rarebook92/%EB%B0%B1%EC%A4%80%EC%9D%80-Swift%EC%97%90%EA%B2%8C-%EA%B4%80%EB%8C%80%ED%95%B4%EB%9D%BC" target="_blank">백준은 Swift 시간초과에 관대해줘라
</a>라는 글에서 발췌하여 수정하여 사용하였다.
