...
<span style="color: green">(</span><span style="color: orange">(</span><span style="color: orange">)</span><span style="color: green">)</span><span style="color: red">(</span><span style="color: red">)</span><br/>
