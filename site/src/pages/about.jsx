          ...
          <Flex sx={styles.grid}>
            <Box sx={styles.column}>
              <Section title='My Story'>
                <Card variant='paper'>
                  <Text variant='p'>
                    <ul><b>안녕하세요! 저는 컴퓨터 공학 전공자로서 머신러닝과 크로스플랫폼 개발에 많은 관심을 가지고 있습니다.</b></ul>
                    <ul><b>최근에는 Flutter와 생성형 AI에 대해 공부하고 있습니다.</b></ul>
                    <ul><b>저의 목표는 제가 습득한 기술들을 융합하여 혁신적인 솔루션을 창조하는 것입니다.</b></ul>
                  </Text>
                </Card>
              </Section>
              <Divider/>
